...
public final class EncryptionDecoder {
    ...
    /// - parameter password: The password to use for decrypting `item`. This password is **never** retained beyond the lifetime of this function's call stack.
    /// - returns: A value of the requested type.
    /// - throws: A `DecodingError` if the item couldn't be decoded.
    ...
    /// - parameter type: The type of the value to decode.
    /// - parameter item: The item to decode.
    /// - parameter key: The key to use for decrypting `item`. This key is **never** retained beyond the lifetime of this function's call stack.
    /// - returns: A value of the requested type.
    /// - throws: A `DecodingError` if the item couldn't be decoded.
