Pod::Spec.new do |spec|
  ...
  spec.version      = "0.3.6"
  spec.summary      = "A Swift API for encrypting arbitrary data and data types."
  ...
  spec.source = { :git => "https://github.com/AverageHelper/ItemEncryptor.git", :tag => "v#{spec.version}" }
